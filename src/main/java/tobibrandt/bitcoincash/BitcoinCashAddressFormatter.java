package tobibrandt.bitcoincash;

import tobibrandt.MoneyNetwork;
import tobibrandt.Utils;
...
public class BitcoinCashAddressFormatter {
	...
	public static final String REG_NET_PREFIX = "bchreg";
	...
	public static boolean isValidCashAddress(String bitcoinCashAddress, MoneyNetwork moneyNetwork) {
		try {
			...
			if (bitcoinCashAddress.contains(SEPARATOR)) {
				...
				if (REG_NET_PREFIX.equals(prefix) && !moneyNetwork.equals(MoneyNetwork.REG)) {
					return false;
				}
			} else {
