...
public class BitcoinTools {
    ...
    public static String getAddressByPrivateKey(String privateKey,byte addressVersion) {
        try {
            byte[] publicKeyBytes = BitcoinTools.getPublicKeyBytes(privateKey);
    ...
    public static String getAddressByScriptPuKey(String scriptPubKey,String coinType) {
        try {
            ...
            if("TEST".equals(coinType)){
                ...
                address[0] = Constant.LTC_ADDRESS_VERSION;
            }else if("QTUM".equals(coinType)){
                address[0] = Constant.QTUM_ADDRESS_VERSION;
            }else{
                address[0] = Constant.ADDRESS_VERSION;
            }
    ...
    public static String getAddressByScriptPuKey(String scriptPubKey,byte addressVersion) {
        try {
    ...
    //public static String getMultisigAddressByScriptPuKey(String script,String coinType) {
    //    try {
    //
    //        byte[] address = new byte[21];
    //        address[0] = 5;
    //        script = script.substring(4,script.length()-2);
    //        System.arraycopy(ByteUtilities.toByteArray(script), 0, address, 1, 20);
    //
    //        MessageDigest md1 = MessageDigest.getInstance(SHA256);
    //        md1.reset();
    //        md1.update(address);
    ...
    public static void main(String[] args) {
        try {
            ...
            byte[] a = ByteUtilities.toByteArray("00000000373431353830393338383237343035313438");
